...
- Параметры подключения сохраняются в файле `appsettings.json` рядом с программой
...
**Хранение паролей:**
- Пароли сохраняются в зашифрованном виде в `appsettings.json`
- При переносе программы на другой компьютер потребуется ввести пароль заново
- Защищайте доступ к файлу `appsettings.json` от посторонних
